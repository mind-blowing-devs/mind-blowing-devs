...
Перед запуском: Создайте `.env` файл в корне проекта (команда `cp .env.sample .env`) и заполните его нужными данными.
Для целей теста и разработки файл можно оставить без изменений в виде `.env.sample`
