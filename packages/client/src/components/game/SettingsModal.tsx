  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-[#BFBFBF] p-6 border-4 border-t-white border-l-white border-r-[#7B7B7B] border-b-[#7B7B7B] max-w-md w-full">
        <h2 className="text-xl font-bold mb-6 text-[#585656]">settings</h2>
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="flex items-center">
            ...
            <div className="relative flex-1">
              <select className="w-full appearance-none bg-[#BFBFBF] px-5 py-1 pr-8 border-2 border-t-[#7B7B7B] border-l-[#7B7B7B] border-r-white border-b-white focus:outline-none">
        ...
        <div className="flex justify-end gap-2">
          <button className="bg-[#BFBFBF] px-4 py-2 border-2 border-t-white border-l-white border-r-[#7B7B7B] border-b-[#7B7B7B] active:border-t-[#7B7B7B] active:border-l-[#7B7B7B] active:border-r-white active:border-b-white">
            save
          </button>
          <button
            onClick={onClose}
